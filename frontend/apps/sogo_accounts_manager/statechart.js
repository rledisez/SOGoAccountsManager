...
SOGoAccountsManager.statechart = SC.Statechart.create({
    trace: NO,

    initialState: 'checkingAuthenticationState',
    
    checkingAuthenticationState: SC.State.plugin('SOGoAccountsManager.CheckingAuthenticationState'),
    operatingApplicationsState: SC.State.plugin('SOGoAccountsManager.OperatingApplicationsState'),
