...
SOGoAccountsManager.OrganizationsApplicationState = SC.State.design({
    //initialSubstate: 'accountsApplicationState',
    
    enterState: function() {
        setActive('mainPage.mainPane.moduleSwitcher.organizationsButton');
    },

    exitState: function() {
        unsetActive('mainPage.mainPane.moduleSwitcher.organizationsButton');
    },
