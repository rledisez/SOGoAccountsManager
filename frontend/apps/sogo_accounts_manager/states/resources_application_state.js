...
SOGoAccountsManager.ResourcesApplicationState = SC.State.design({
    //initialSubstate: 'accountsApplicationState',
    
    enterState: function() {
        setActive('mainPage.mainPane.moduleSwitcher.resourcesButton');
    },

    exitState: function() {
        unsetActive('mainPage.mainPane.moduleSwitcher.resourcesButton');
    },
