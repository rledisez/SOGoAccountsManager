...
SOGoAccountsManager.DomainsApplicationState = SC.State.design({
    //initialSubstate: 'accountsApplicationState',
    
    enterState: function() {
        setActive('mainPage.mainPane.moduleSwitcher.domainsButton');
    },

    exitState: function() {
        unsetActive('mainPage.mainPane.moduleSwitcher.domainsButton');
    },
